...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ f('pagetitle', l('Detail {0}', Inflector::humanize(f('controller')->getClass()))) }}</h5>
            <!--end::Page Title-->
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{ f('controller.url', '/:id/update') }}" class="btn btn-light-primary font-weight-bold">
                <span class="svg-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <a href="#theModal" data-title="Delete Record" data-remote="{{ f('controller.url', '/:id/trash') }}" data-toggle="modal" data-target="#theModal" class="btn btn-light-danger font-weight-bold ml-2 mr-2" title="Delete record">
                <span class="svg-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
